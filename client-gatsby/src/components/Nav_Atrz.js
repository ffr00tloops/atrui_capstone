...
export default function Nav_Atrz() {
    ...
    function VerifyAuth() {
        ...
        function VerifyRole() {
            ...
            if (role.role != undefined) {
                if(role.role === 'organizer') {
                    return (
                    <>
                        <Link to="/user/home"><h1 className="hide-mobile drop-shadow p-3 m-3 text-lg rounded-lg text-white bg-green-500">Homepage</h1></Link>
        ...
        if (isAuthenticated) {
            ...
            return <button onClick={loginWithRedirect} className="p-3 m-3 text-xl rounded-lg text-white bg-red-500">Login</button>
        };
